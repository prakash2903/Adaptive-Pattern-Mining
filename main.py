...
# === CONFIG ===
PANE_SIZE = 5
#INIT_WINDOW_SIZE = 2  # number of panes
...
def main():
    ...
    drift_tracker = DriftTracker()  # ✅ Moved outside the loop
    ...
    for pane_index, pane in enumerate(panes):
        ...
        # ⚠️ Concept Drift Detection and Window Adjustment
        drift_rate = 0
        ...
        # Optional plot for frequent itemsets (can be commented for speed)
